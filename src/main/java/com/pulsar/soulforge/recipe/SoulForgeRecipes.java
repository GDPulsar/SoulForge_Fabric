...
public class SoulForgeRecipes {
    ...
    public static void register() {
        ...
        SOUL_FORGE_RECIPE = Registry.register(Registries.RECIPE_TYPE, new Identifier(SoulForge.MOD_ID, SoulForgeRecipe.Type.ID), SoulForgeRecipe.Type.INSTANCE);
        Registry.register(Registries.RECIPE_SERIALIZER, SiphonRecipe.Serializer.ID, SiphonRecipe.Serializer.INSTANCE);
        SIPHON_RECIPE = Registry.register(Registries.RECIPE_TYPE, new Identifier(SoulForge.MOD_ID, SiphonRecipe.Type.ID), SiphonRecipe.Type.INSTANCE);
    }
}
