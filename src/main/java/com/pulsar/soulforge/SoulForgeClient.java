...
public class SoulForgeClient implements ClientModInitializer {
	public static EntityModelLayer MODEL_FROZEN_ENERGY_LAYER = new EntityModelLayer(Identifier.of(SoulForge.MOD_ID, "frozen_energy"), "Frozen Energy");
	...
	public void onInitializeClient() {
		...
		ModelPredicateProviderRegistry.register(SoulForgeItems.INTEGRITY_RAPIER, Identifier.of("parrying"), (stack, world, entity, i) -> {
		...
		ModelPredicateProviderRegistry.register(SoulForgeItems.DETERMINATION_RAPIER, Identifier.of("parrying"), (stack, world, entity, i) -> {
			if (entity instanceof PlayerEntity player) {
				SoulComponent playerSoul = SoulForge.getPlayerSoul(player);
				if (playerSoul.hasValue("parry")) {
					if (playerSoul.getValue("parry") > 0) return 1f;
		...
		ModelPredicateProviderRegistry.register(SoulForgeItems.DETERMINATION_SWORD, Identifier.of("blocking"), (stack, world, entity, i) ->
				entity != null && entity.isUsingItem() && entity.getActiveItem() == stack ? 1f : 0f);
		ModelPredicateProviderRegistry.register(SoulForgeItems.KINDNESS_SHIELD, Identifier.of("blocking"), (stack, world, entity, i) ->
				entity != null && entity.isUsingItem() && entity.getActiveItem() == stack ? 1f : 0f);
		ModelPredicateProviderRegistry.register(SoulForgeItems.JUSTICE_BOW, Identifier.of("pulling"), ((stack, world, entity, seed) -> {
			if (entity == null) return 0f;
			return entity.isUsingItem() && entity.getActiveItem() == stack ? 1f : 0f;
		}));
		ModelPredicateProviderRegistry.register(SoulForgeItems.JUSTICE_BOW, Identifier.of("pull"), ((stack, world, entity, seed) -> {
			if (entity == null) return 0f;
			return entity.getActiveItem() != stack ? 0f : (stack.getMaxUseTime(entity) - entity.getItemUseTimeLeft()) / 10f;
		}));
		ModelPredicateProviderRegistry.register(SoulForgeItems.DETERMINATION_BOW, Identifier.of("pulling"), ((stack, world, entity, seed) -> {
			if (entity == null) return 0f;
			return entity.isUsingItem() && entity.getActiveItem() == stack ? 1f : 0f;
		}));
		ModelPredicateProviderRegistry.register(SoulForgeItems.DETERMINATION_BOW, Identifier.of("pull"), ((stack, world, entity, seed) -> {
			if (entity == null) return 0f;
			return entity.getActiveItem() != stack ? 0f : (stack.getMaxUseTime(entity) - entity.getItemUseTimeLeft()) / 10f;
		}));
		ModelPredicateProviderRegistry.register(SoulForgeItems.JUSTICE_CROSSBOW, Identifier.of("pulling"), ((stack, world, entity, seed) -> {
			if (entity == null) return 0f;
			return entity.isUsingItem() && entity.getActiveItem() == stack ? 1f : 0f;
		}));
		ModelPredicateProviderRegistry.register(SoulForgeItems.JUSTICE_CROSSBOW, Identifier.of("pull"), ((stack, world, entity, seed) -> {
			if (entity == null) return 0f;
			return entity.getActiveItem() != stack ? 0f : (stack.getMaxUseTime(entity) - entity.getItemUseTimeLeft()) / 10f;
		}));
		ModelPredicateProviderRegistry.register(SoulForgeItems.JUSTICE_CROSSBOW, Identifier.of("loaded"), ((stack, world, entity, seed) -> {
			if (entity == null) return 0f;
			return ((JusticeCrossbow)stack.getItem()).loaded ? 1f : 0f;
		}));
		ModelPredicateProviderRegistry.register(SoulForgeItems.DETERMINATION_CROSSBOW, Identifier.of("pulling"), ((stack, world, entity, seed) -> {
			if (entity == null) return 0f;
			return entity.isUsingItem() && entity.getActiveItem() == stack ? 1f : 0f;
		}));
		ModelPredicateProviderRegistry.register(SoulForgeItems.DETERMINATION_CROSSBOW, Identifier.of("pull"), ((stack, world, entity, seed) -> {
			if (entity == null) return 0f;
			return entity.getActiveItem() != stack ? 0f : (stack.getMaxUseTime(entity) - entity.getItemUseTimeLeft()) / 10f;
		}));
		ModelPredicateProviderRegistry.register(SoulForgeItems.DETERMINATION_CROSSBOW, Identifier.of("loaded"), ((stack, world, entity, seed) -> {
			if (entity == null) return 0f;
		...
		ClampedModelPredicateProvider siphonProvider = (stack, world, entity, seed) -> {
			if (stack.isIn(ItemTags.TRIMMABLE_ARMOR) || stack.isOf(Items.BOW) || stack.isOf(Items.CROSSBOW) || stack.isIn(ItemTags.PICKAXES)
					|| stack.isIn(ItemTags.AXES) || stack.isIn(ItemTags.SHOVELS) || stack.isIn(ItemTags.HOES) || stack.isOf(Items.TRIDENT)) {
				if (world == null || stack.get(SoulForgeItems.SIPHON_COMPONENT) == null) return 0.0F;
		...
		ModelPredicateProviderRegistry.register(Identifier.of("siphon_type"), siphonProvider);
