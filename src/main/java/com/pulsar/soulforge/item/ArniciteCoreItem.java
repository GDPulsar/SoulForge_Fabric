...
public class ArniciteCoreItem extends Item implements GeoItem {
    public ArniciteCoreItem() {
    ...
    public void createRenderer(Consumer<Object> consumer) {
        consumer.accept(new RenderProvider() {
            private final ArniciteCoreItemRenderer renderer = new ArniciteCoreItemRenderer();
