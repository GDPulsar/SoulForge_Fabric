...
public class Shatterdrill extends DeviceBase implements GeoItem {
    public Shatterdrill() {
        super(new Item.Settings().maxCount(1).rarity(Rarity.RARE).component(DataComponentTypes.TOOL,
                ToolMaterials.IRON.createComponent(BlockTags.PICKAXE_MINEABLE)), 300, Traits.bravery);
