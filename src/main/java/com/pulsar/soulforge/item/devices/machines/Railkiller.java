...
public class Railkiller extends DeviceBase implements GeoItem {
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!(world instanceof ServerWorld)) {
            ...
            Vec3d shootDir = context.getPlayer().getRotationVector().withAxis(Direction.Axis.Y, 0);
            if (shootDir.length() <= 0f) shootDir = new Vec3d(1f, 0f, 0f);
            railkillerEntity.setDirection(shootDir);
