...
public class DeterminationSpear extends MagicSwordItem {
    public DeterminationSpear() {
        super(6, 1.4f, 0.25f);
        addAttribute(EntityAttributes.PLAYER_ENTITY_INTERACTION_RANGE, new EntityAttributeModifier(Identifier.of(SoulForge.MOD_ID, "dt_spear_reach"), 2f, EntityAttributeModifier.Operation.ADD_VALUE));
    }
