...
public class DeterminationClaw extends MagicSwordItem implements GeoItem {
    ...
    public void createRenderer(Consumer<Object> consumer) {
        consumer.accept(new RenderProvider() {
            private final GeoItemRenderer<DeterminationClaw> renderer = new GeoMagicItemRenderer<>("claw", "determination");
