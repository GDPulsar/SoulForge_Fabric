...
public class SoulForgeItems {
    public static Item RegisterItem(String id, Item.Settings settings) {
        Item item = Registry.register(Registries.ITEM, Identifier.of(SoulForge.MOD_ID, id), new Item(settings));
        addToItemGroup(item);
        return item;
    }

    public static Item RegisterItem(String id, Item item) {
        Item registered = Registry.register(Registries.ITEM, Identifier.of(SoulForge.MOD_ID, id), item);
        addToItemGroup(registered);
        return registered;
    }
    public static Item RegisterItem(String id, Item.Settings settings, boolean addToGroup) {
        Item item = Registry.register(Registries.ITEM, Identifier.of(SoulForge.MOD_ID, id), new Item(settings));
    ...
    public static final RegistryKey<ItemGroup> ITEM_GROUP = RegistryKey.of(RegistryKeys.ITEM_GROUP, Identifier.of(SoulForge.MOD_ID, "item_group"));

    public static ComponentType<Siphon.Type> SIPHON_COMPONENT;
    public static ComponentType<String> RELOAD_COMPONENT;
    public static ComponentType<Boolean> IMBUED_COMPONENT;
    public static ComponentType<Boolean> MOUSE_DOWN_COMPONENT;
    public static ComponentType<Boolean> ACTIVE_COMPONENT;
    public static ComponentType<Boolean> RELOADED_COMPONENT;
    public static ComponentType<Boolean> THROWN_COMPONENT;
    public static ComponentType<Integer> HEAT_COMPONENT;
    public static ComponentType<Integer> CHARGE_COMPONENT;
    public static ComponentType<Integer> TIMER_COMPONENT;
    public static ComponentType<Integer> AMMO_COMPONENT;
    public static ComponentType<Integer> RELOAD_COUNT_COMPONENT;
    public static ComponentType<UUID> IMBUED_ID_COMPONENT;
    public static ComponentType<UUID> TARGET_ID_COMPONENT;
    public static ComponentType<String> WORLD_COMPONENT;
    public static ComponentType<Vec3d> POSITION_COMPONENT;

    public static void registerItems() {
        SIPHON_COMPONENT = Registry.register(Registries.DATA_COMPONENT_TYPE, Identifier.of(SoulForge.MOD_ID, "siphon"), ComponentType.<Siphon.Type>builder().build());
        RELOAD_COMPONENT = Registry.register(Registries.DATA_COMPONENT_TYPE, Identifier.of(SoulForge.MOD_ID, "reload"), ComponentType.<String>builder().build());
        WORLD_COMPONENT = Registry.register(Registries.DATA_COMPONENT_TYPE, Identifier.of(SoulForge.MOD_ID, "world"), ComponentType.<String>builder().build());
        IMBUED_COMPONENT = Registry.register(Registries.DATA_COMPONENT_TYPE, Identifier.of(SoulForge.MOD_ID, "imbued"), ComponentType.<Boolean>builder().build());
        MOUSE_DOWN_COMPONENT = Registry.register(Registries.DATA_COMPONENT_TYPE, Identifier.of(SoulForge.MOD_ID, "mouse_down"), ComponentType.<Boolean>builder().build());
        ACTIVE_COMPONENT = Registry.register(Registries.DATA_COMPONENT_TYPE, Identifier.of(SoulForge.MOD_ID, "active"), ComponentType.<Boolean>builder().build());
        RELOADED_COMPONENT = Registry.register(Registries.DATA_COMPONENT_TYPE, Identifier.of(SoulForge.MOD_ID, "reloaded"), ComponentType.<Boolean>builder().build());
        THROWN_COMPONENT = Registry.register(Registries.DATA_COMPONENT_TYPE, Identifier.of(SoulForge.MOD_ID, "thrown"), ComponentType.<Boolean>builder().build());
        HEAT_COMPONENT = Registry.register(Registries.DATA_COMPONENT_TYPE, Identifier.of(SoulForge.MOD_ID, "heat"), ComponentType.<Integer>builder().build());
        CHARGE_COMPONENT = Registry.register(Registries.DATA_COMPONENT_TYPE, Identifier.of(SoulForge.MOD_ID, "charge"), ComponentType.<Integer>builder().build());
        TIMER_COMPONENT = Registry.register(Registries.DATA_COMPONENT_TYPE, Identifier.of(SoulForge.MOD_ID, "timer"), ComponentType.<Integer>builder().build());
        AMMO_COMPONENT = Registry.register(Registries.DATA_COMPONENT_TYPE, Identifier.of(SoulForge.MOD_ID, "ammo"), ComponentType.<Integer>builder().build());
        RELOAD_COUNT_COMPONENT = Registry.register(Registries.DATA_COMPONENT_TYPE, Identifier.of(SoulForge.MOD_ID, "reload_count"), ComponentType.<Integer>builder().build());
        IMBUED_ID_COMPONENT = Registry.register(Registries.DATA_COMPONENT_TYPE, Identifier.of(SoulForge.MOD_ID, "imbued_id"), ComponentType.<UUID>builder().build());
        TARGET_ID_COMPONENT = Registry.register(Registries.DATA_COMPONENT_TYPE, Identifier.of(SoulForge.MOD_ID, "target_id"), ComponentType.<UUID>builder().build());
        POSITION_COMPONENT = Registry.register(Registries.DATA_COMPONENT_TYPE, Identifier.of(SoulForge.MOD_ID, "position"), ComponentType.<Vec3d>builder().build());
        ...
        for (int i = 0; i < traits.length; i++) {
            for (int j = i; j < traits.length; j++) {
                ...
                SOULS.put(key, RegisterItem(key, new Item.Settings()));
            }
        }
        SOULS.put("determination", RegisterItem("determination", new Item.Settings()));
        INTEGRITY_ESSENCE = RegisterItem("integrity_essence", new Item.Settings());
        KINDNESS_ESSENCE = RegisterItem("kindness_essence", new Item.Settings());
        PATIENCE_ESSENCE = RegisterItem("patience_essence", new Item.Settings());
        JUSTICE_ESSENCE = RegisterItem("justice_essence", new Item.Settings());
        BRAVERY_ESSENCE = RegisterItem("bravery_essence", new Item.Settings());
        PERSEVERANCE_ESSENCE = RegisterItem("perseverance_essence", new Item.Settings());
        ...
        COLOSSAL_CLAYMORE_DISPLAY = RegisterItem("colossal_claymore_display", new Item.Settings().maxCount(1));
        ...
        FROSTBITE_ROUND = RegisterItem("frostbite_round", new Item.Settings());
        CRUSHING_ROUND = RegisterItem("crushing_round", new Item.Settings());
        PUNCTURING_ROUND = RegisterItem("puncturing_round", new Item.Settings());
        SUPPRESSING_ROUND = RegisterItem("suppressing_round", new Item.Settings());
        ...
        SIPHON_TEMPLATE = RegisterItem("siphon_template", new Item.Settings());
        ...
        BRAVERY_GUMMY = RegisterItem("bravery_gummy", new Item.Settings().food(new FoodComponent.Builder().nutrition(1).snack().build()));
        JUSTICE_GUMMY = RegisterItem("justice_gummy", new Item.Settings().food(new FoodComponent.Builder().nutrition(1).snack().build()));
        KINDNESS_GUMMY = RegisterItem("kindness_gummy", new Item.Settings().food(new FoodComponent.Builder().nutrition(1).snack().build()));
        PATIENCE_GUMMY = RegisterItem("patience_gummy", new Item.Settings().food(new FoodComponent.Builder().nutrition(1).snack().build()));
        INTEGRITY_GUMMY = RegisterItem("integrity_gummy", new Item.Settings().food(new FoodComponent.Builder().nutrition(1).snack().build()));
        PERSEVERANCE_GUMMY = RegisterItem("perseverance_gummy", new Item.Settings().food(new FoodComponent.Builder().nutrition(1).snack().build()));
        DETERMINATION_GUMMY = RegisterItem("determination_gummy", new Item.Settings().food(new FoodComponent.Builder().nutrition(2).snack().build()));
