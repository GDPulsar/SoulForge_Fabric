...
public class Paranoia implements TraitBase {
    public final String name = "Paranoia";
    public final Identifier identifier = new Identifier(SoulForge.MOD_ID, "paranoia");
