...
public class Ineptitude implements TraitBase {
    public final String name = "Ineptitude";
    public final Identifier identifier = new Identifier(SoulForge.MOD_ID, "ineptitude");
