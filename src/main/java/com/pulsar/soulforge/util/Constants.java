...
public class Constants {
    ...
    public static HashMap<RegistryEntry<StatusEffect>, RegistryEntry<StatusEffect>> effectInversion = new HashMap<>(Map.ofEntries(
    ...
    public static HashMap<RegistryEntry<StatusEffect>, Integer> effectHighest = new HashMap<>(Map.ofEntries(
