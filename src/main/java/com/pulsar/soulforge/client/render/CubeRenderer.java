...
public class CubeRenderer {
    ...
    private static void renderQuad(
        ...
        vertices.vertex(model, p1.x, p1.y, p1.z).texture(0, 0).overlay(0).light(255).normal(0, 1, 0);
        vertices.vertex(model, p2.x, p2.y, p2.z).texture(0, 0).overlay(0).light(255).normal(0, 1, 0);
        vertices.vertex(model, p3.x, p3.y, p3.z).texture(0, 0).overlay(0).light(255).normal(0, 1, 0);
        vertices.vertex(model, p4.x, p4.y, p4.z).texture(0, 0).overlay(0).light(255).normal(0, 1, 0);
    }
}
