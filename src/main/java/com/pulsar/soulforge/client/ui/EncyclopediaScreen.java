...
public class EncyclopediaScreen extends Screen {
    public static final Identifier TEXTURE = Identifier.of("soulforge","textures/ui/encyclopedia.png");
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        switch (currentPage) {
            case 0:
                context.drawTexture(Identifier.of(SoulForge.MOD_ID, "icon.png"), left + 32, top + 19, 0, 0, 79, 79, 79, 79);
                ...
                for (AbilityBase ability : abilities) {
                    ...
                    if (currentPage == i) {
                        ...
                        if (playerSoul.hasDiscovered(ability)) {
                            texture = Identifier.of(SoulForge.MOD_ID, "textures/ui/ability_icon/" + ability.getID().getPath() + ".png");
                            ...
                            texture = Identifier.of(SoulForge.MOD_ID, "textures/ui/ability_icon/grayscale/" + ability.getID().getPath() + ".png");
    ...
    public static class PageButton extends ClickableWidget {
        ...
        protected void renderWidget(DrawContext context, int mouseX, int mouseY, float delta) {
            ...
            context.drawTexture(Identifier.of("textures/gui/book.png"), this.getX(), this.getY(), u, v, 18, 10, 256, 256);
        }
