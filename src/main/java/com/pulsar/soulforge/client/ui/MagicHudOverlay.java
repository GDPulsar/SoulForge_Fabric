...
public class MagicHudOverlay implements HudRenderCallback {
    ...
    public void renderMagicBar(DrawContext context) {
        ...
        context.drawTexture(Identifier.of(SoulForge.MOD_ID, "textures/ui/magic/bar_background.png"), left, top, 0, 0, 16, 106, 16, 106);
    ...
    public void renderMagicBALLS(DrawContext context) {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            if (magic < (i + 1) * 10 && magic >= i * 10) {
                Identifier texture = Identifier.of(SoulForge.MOD_ID, "textures/ui/magic/" + traitName + "/magic_" + (magic % 10) + ".png");
                context.drawTexture(texture, 5, y - 30 - (i * 14), 0, 0, 12, 12, 12, 12);
            } else if (magic < (i + 1) * 10) {
                Identifier texture = Identifier.of(SoulForge.MOD_ID, "textures/ui/magic/" + traitName + "/magic_0.png");
                context.drawTexture(texture, 5, y - 30 - (i * 14), 0, 0, 12, 12, 12, 12);
            } else {
                Identifier texture = Identifier.of(SoulForge.MOD_ID, "textures/ui/magic/" + traitName + "/magic_10.png");
                context.drawTexture(texture, 5, y - 30 - (i * 14), 0, 0, 12, 12, 12, 12);
            }
        }
    }
