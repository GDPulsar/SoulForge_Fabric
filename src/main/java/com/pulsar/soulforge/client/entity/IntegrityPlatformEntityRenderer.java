...
public class IntegrityPlatformEntityRenderer extends EntityRenderer<IntegrityPlatformEntity> {
    ...
    public void render(IntegrityPlatformEntity platformEntity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        ...
        CylinderRenderer.renderCylinder(matrix, vertexConsumer,  new Vector3f(0f, -0.1f, 0f), new Vector3f(0f, 0.325f, 0f), 1.4f, new Color(0f, 0f, 1f, 0.5f), OverlayTexture.DEFAULT_UV, 255, false);
        if (platformEntity.getStack() >= 1) CylinderRenderer.renderCylinder(matrix, vertexConsumer,  new Vector3f(0f, -0.225f, 0f), new Vector3f(0f, 0.225f, 0f), 1.9f, new Color(0f, 0f, 1f, 0.5f), OverlayTexture.DEFAULT_UV, 255, false);
        if (platformEntity.getStack() == 2) CylinderRenderer.renderCylinder(matrix, vertexConsumer,  new Vector3f(0f, -0.325f, 0f), new Vector3f(0f, 0.125f, 0f), 2.4f, new Color(0f, 0f, 1f, 0.5f), OverlayTexture.DEFAULT_UV, 255, false);
    }
}
