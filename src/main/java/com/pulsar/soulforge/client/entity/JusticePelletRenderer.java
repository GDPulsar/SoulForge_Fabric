...
public class JusticePelletRenderer extends EntityRenderer<JusticePelletProjectile> {
    private static final Identifier JUSTICE_TEXTURE = Identifier.of(SoulForge.MOD_ID, "textures/item/justice.png");
    private static final Identifier KINDNESS_TEXTURE = Identifier.of(SoulForge.MOD_ID, "textures/item/kindness.png");
