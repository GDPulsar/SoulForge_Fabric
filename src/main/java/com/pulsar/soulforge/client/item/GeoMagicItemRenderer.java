...
public class GeoMagicItemRenderer<T extends Item & GeoAnimatable> extends GeoItemRenderer<T> {
    public GeoMagicItemRenderer(String itemID, String textureID) {
        super(new GeoMagicItemModel<>(new Identifier(SoulForge.MOD_ID, "geo/item/" + itemID + ".geo.json"), new Identifier(SoulForge.MOD_ID, "textures/item/" + textureID + ".png")));
    }

    public GeoMagicItemRenderer(String itemID, String textureID, String animID) {
        super(new GeoMagicItemModel<>(
                new Identifier(SoulForge.MOD_ID, "geo/item/" + itemID + ".geo.json"),
                new Identifier(SoulForge.MOD_ID, "textures/item/" + textureID + ".png"),
                new Identifier(SoulForge.MOD_ID, "animations/item/" + animID + ".animation.json")
        ));
    }
