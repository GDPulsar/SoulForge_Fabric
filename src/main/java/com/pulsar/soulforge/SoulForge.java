...
public class SoulForge implements ModInitializer {
	...
	public void onInitialize() {
		LOGGER.info("Loading SoulForge v2.0.6");
		...
		SOUL_FORGE_SCREEN_HANDLER = Registry.register(Registries.SCREEN_HANDLER, Identifier.of(MOD_ID, "soul_forge_screen"), new ScreenHandlerType<>(SoulForgeScreenHandler::new, FeatureFlags.VANILLA_FEATURES));
		CREATIVE_ZONE_SCREEN_HANDLER = Registry.register(Registries.SCREEN_HANDLER, Identifier.of(MOD_ID, "creative_zone_screen"), new ScreenHandlerType<>(CreativeZoneScreenHandler::new, FeatureFlags.VANILLA_FEATURES));
		...
		ArgumentTypeRegistry.registerArgumentType(Identifier.of(MOD_ID, "trait"), TraitArgumentType.class, ConstantArgumentSerializer.of(TraitArgumentType::trait));
