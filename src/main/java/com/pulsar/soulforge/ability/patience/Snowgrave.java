...
public class Snowgrave extends AbilityBase {
    ...
    public boolean cast(ServerPlayerEntity player) {
        ...
        if (result != null) {
            if (result.squaredDistanceTo(player) <= 2500f) {
                ...
                Utils.addModifier(player, EntityAttributes.GENERIC_MOVEMENT_SPEED, "snowgrave", -1, EntityAttributeModifier.Operation.ADD_MULTIPLIED_TOTAL);
                ...
                if (player.getServer() != null) {
                    SoulForgeNetworking.broadcast(null, player.getServer(), new PerformAnimationPacket(player.getUuid(), "snowgrave", true));
                }
    ...
    public boolean tick(ServerPlayerEntity player) {
        ...
        if (timer <= 420) {
            ...
            ServerPlayNetworking.send(player, new PositionVelocityPacket(playerPos.toVector3f(), new Vector3f(), new Vector3f()));
        }
        return timer >= 470;
    }
    ...
    public boolean end(ServerPlayerEntity player) {
        ...
        Utils.removeModifier(player, EntityAttributes.GENERIC_MOVEMENT_SPEED, "snowgrave");
