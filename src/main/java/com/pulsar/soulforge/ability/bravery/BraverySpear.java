...
public class BraverySpear extends AbilityBase {
    public final String name = "Bravery Spear";
    public final Identifier id = new Identifier(SoulForge.MOD_ID, "bravery_spear");
