...
public class TrueLOVE extends AbilityBase {
    public final String name = "True LOVE";
    public final Identifier id = new Identifier(SoulForge.MOD_ID, "true_love");
    public final int requiredLv = 1;
    public final int cost = 0;
    public final int cooldown = 0;
    public final AbilityType type = AbilityType.PASSIVE;
