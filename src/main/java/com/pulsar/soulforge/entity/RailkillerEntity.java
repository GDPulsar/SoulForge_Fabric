...
public class RailkillerEntity extends Entity implements GeoEntity {
    ...
    protected void initDataTracker(DataTracker.Builder builder) {
        ...
        builder.add(DIRECTION, new Vector3f());
    ...
    public void writeCustomDataToNbt(NbtCompound nbt) {
        ...
        nbt.put("stack", stack.encode(this.getRegistryManager()));
    ...
    public void readCustomDataFromNbt(NbtCompound nbt) {
        if (nbt.contains("stack")) {
            this.dataTracker.set(STACK, ItemStack.fromNbtOrEmpty(this.getRegistryManager(), nbt.getCompound("stack")));
        }
