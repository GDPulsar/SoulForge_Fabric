...
public class EnergyBallProjectile extends ProjectileEntity {
    ...
    public void tick() {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            Vec3d velocity = offset.normalize().multiply(0.0005f);
            this.getWorld().addParticle(SoulForgeParticles.FIRE_PARTICLE, pos.x, pos.y, pos.z, velocity.x, velocity.y, velocity.z);
        }
