...
public class BigSlashProjectile extends ProjectileEntity implements GeoAnimatable {
    public BigSlashProjectile(EntityType<? extends ProjectileEntity> entityType, World world) {
        super(entityType, world);
    }

    public BigSlashProjectile(World world, PlayerEntity player) {
    ...
    protected void onCollision(HitResult hitResult) {
        ...
        this.getWorld().createExplosion(this, this.getX(), this.getY(), this.getZ(), 2f, World.ExplosionSourceType.NONE);
        this.destroy();
    }
